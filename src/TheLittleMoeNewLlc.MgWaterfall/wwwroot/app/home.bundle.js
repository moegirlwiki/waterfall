...
/** @jsx React.DOM */var Masonry = __webpack_require__(12);
...
var Gallery = React.createClass({displayName: "Gallery",
    render: function () {
        var childElements = this.props.elements.map(function (element) {
            return (
                React.createElement("div", {className: "card", key: element.key}, 
                    React.createElement("img", {className: "card-cover", src: element.src}), 
                    React.createElement("h1", {className: "card-title"}, element.title)
                )
            );
        });
...
ReactDOM.render(
    React.createElement(Gallery, {elements: cards}),
...
var Masonry = isBrowser ? window.Masonry || __webpack_require__(13) : null;
var imagesloaded = isBrowser ? __webpack_require__(18) : null;
var assign = __webpack_require__(19);
var elementResizeDetectorMaker = __webpack_require__(20);
